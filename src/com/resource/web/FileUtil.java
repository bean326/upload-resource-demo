...
public class FileUtil {
    ...
    public void mergePartFiles(String dirPath, String partFileSuffix,
        ...
        RandomAccessFile randomAccessFile = new RandomAccessFile(mergeFileName,
                "rw");
        randomAccessFile.setLength(partFileSize);
        ...
        for (int i = 0; i < partFiles.size(); i++) {
            ...
            threadPool.execute(new MergeRunnable(index,
    ...
    private class FileComparator implements Comparator<File> {
        public int compare(File o1, File o2) {
            ...
            return Integer.parseInt(o1.getName().replace(".tt", "")) - Integer.parseInt(o2.getName().replace(".tt", ""));
        }
    }
